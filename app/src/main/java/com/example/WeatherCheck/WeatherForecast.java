...
public class WeatherForecast implements Forecast {
    ...
    public WeatherForecast(String dayOfWeek, String weatherCondition) {
        this.dayOfWeek = dayOfWeek;
        this.weatherCondition = weatherCondition;
    }

    public WeatherForecast(String dayOfWeek, String weatherCondition, String minTemperature, String maxTemperature,
