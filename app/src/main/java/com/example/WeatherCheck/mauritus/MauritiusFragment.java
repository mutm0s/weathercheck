...
public class MauritiusFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            rootView = inflater.inflate(R.layout.activity_mauritius_land, container, false);
        } else {
            rootView = inflater.inflate(R.layout.activity_mauritius, container, false);
        }
        ...
        new MauritiusFragment.FetchWeatherForecastTask().execute();
    ...
    private List<ModelForecast> fetchFromParser1() {
        try {
            ...
            String xmlData = fetchDataFromUrl("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/934154");
