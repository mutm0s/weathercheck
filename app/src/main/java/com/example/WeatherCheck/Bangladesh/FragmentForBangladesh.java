...
public class FragmentForBangladesh extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String bangladeshUrl = "https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/1185241";
        ...
        new AsyncTask<Void, Void, List<WeatherForecast>>() {
            ...
            protected List<WeatherForecast> doInBackground(Void... voids) {
                try {
                    ...
                    InputStream inputStream = new URL(bangladeshUrl).openStream();
