...
public class BangladeshFragent extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            rootView = inflater.inflate(R.layout.activity_bangladesh_land, container, false);
        } else {
            rootView = inflater.inflate(R.layout.activity_bangladesh, container, false);
        }
        ...
        new BangladeshFragent.FetchWeatherForecastTask().execute();
    ...
    private List<ModelForecast> fetchFromParser1() {
        try {
            ...
            String xmlData = fetchDataFromUrl("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/1185241");
