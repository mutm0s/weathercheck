...
public class BangladeshSwitch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        observerFragment = new SecFragmentForBangladesh();
        forecastFragment = new FragmentForBangladesh();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
                                                                     ...
                                                                     public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                                                                         ...
                                                                         if (id == R.id.menu_observer) {
                                                                             ...
                                                                             startActivity(new Intent(BangladeshSwitch.this, MainActivity.class));
                                                                             return true;
                                                                         }
                                                                         else {
                                                                             return false;
