...
public class MapActivityBangladesh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.previous) {
                    startActivity(new Intent( MapActivityBangladesh.this, MainActivity.class));
                    return true;
    ...
    private void showWeatherOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityBangladesh.this, MauritiusSwitch.class));
                    break;
                case 1:
                    startActivity(new Intent(MapActivityBangladesh.this, LondonSwitch.class));

                    break;
                case 2:
                    startActivity(new Intent(MapActivityBangladesh.this, GlasgowSwitch.class));
                    break;
                case 3:
                    startActivity(new Intent(MapActivityBangladesh.this, NewyorkSwitch.class));

                    break;
                case 4:
                    startActivity(new Intent(MapActivityBangladesh.this, BangladeshSwitch.class));

                    break;

                case 5:
                    startActivity(new Intent(MapActivityBangladesh.this, OmanSwitch.class));
                    break;
            }
        });
    ...
    private void showMapsOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityBangladesh.this, MapActivity.class));
                    break;
                case 1:

                    startActivity(new Intent(MapActivityBangladesh.this, MapActivityLondon.class));
                    break;
                case 2:
                    startActivity(new Intent(MapActivityBangladesh.this, MapActivityGlasgow.class));;
                    break;
                case 3:
                    startActivity(new Intent(MapActivityBangladesh.this, MapActivityNewYork.class));
                    break;
                case 4:
                    startActivity(new Intent(MapActivityBangladesh.this, MapActivityBangladesh.class));
                    break;

                case 5:
                    startActivity(new Intent(MapActivityBangladesh.this, MapActivityOman.class));
                    break;
            }
        });
        AlertDialog dialog = builder.create();
