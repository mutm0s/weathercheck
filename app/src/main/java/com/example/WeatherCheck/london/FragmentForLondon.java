...
public class FragmentForLondon extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String londonUrl = "https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/2643763";
        ...
        new AsyncTask<Void, Void, List<WeatherForecast>>() {
            ...
            protected List<WeatherForecast> doInBackground(Void... voids) {
                try {
                    ...
                    InputStream inputStream = new URL(londonUrl).openStream();
