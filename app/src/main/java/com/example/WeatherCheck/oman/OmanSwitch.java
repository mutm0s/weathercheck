...
public class OmanSwitch  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        observerFragment = new SecFragmentForOman();
        forecastFragment = new FragmentForOman();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
                                                                     ...
                                                                     public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                                                                         ...
                                                                         if (id == R.id.menu_observer) {
                                                                             ...
                                                                             startActivity(new Intent(OmanSwitch.this, MainActivity.class));
                                                                             return true;
                                                                         }
                                                                         else {
                                                                             return false;
