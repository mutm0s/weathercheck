...
public class MapActivityOman extends AppCompatActivity {
   ...
   MapAdapter mapAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.previous) {
                    startActivity(new Intent( MapActivityOman.this, MainActivity.class));
    ...
    private void showWeatherOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityOman.this, MauritiusSwitch.class));
                    break;
                case 1:
                    startActivity(new Intent(MapActivityOman.this, LondonSwitch.class));

                    break;
                case 2:
                    startActivity(new Intent(MapActivityOman.this, GlasgowSwitch.class));
                    break;
                case 3:
                    startActivity(new Intent(MapActivityOman.this, NewyorkSwitch.class));

                    break;
                case 4:
                    startActivity(new Intent(MapActivityOman.this, BangladeshSwitch.class));

                    break;

                case 5:
                    startActivity(new Intent(MapActivityOman.this, OmanSwitch.class));
                    break;
            }
        });
    ...
    private void showMapsOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityOman.this, MapActivity.class));
                    break;
                case 1:

                    startActivity(new Intent(MapActivityOman.this, MapActivityLondon.class));
                    break;
                case 2:
                    startActivity(new Intent(MapActivityOman.this, MapActivityGlasgow.class));;
                    break;
                case 3:
                    startActivity(new Intent(MapActivityOman.this, MapActivityNewYork.class));
                    break;
                case 4:
                    startActivity(new Intent(MapActivityOman.this, MapActivityBangladesh.class));
                    break;

                case 5:
                    startActivity(new Intent(MapActivityOman.this, MapActivityOman.class));
                    break;
            }
        });
        AlertDialog dialog = builder.create();
