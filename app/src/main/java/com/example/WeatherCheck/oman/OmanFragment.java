...
public class OmanFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            rootView = inflater.inflate(R.layout.activity_oman_land, container, false);
        } else {
            rootView = inflater.inflate(R.layout.activity_oman, container, false);
        }
    ...
    private List<ModelForecast> fetchFromParser1() {
        try {
            ...
            String xmlData = fetchDataFromUrl("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/287286");
