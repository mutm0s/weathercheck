...
public class NewyorkFragment  extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            rootView = inflater.inflate(R.layout.activity_newyork_land, container, false);
        } else {
            rootView = inflater.inflate(R.layout.activity_newyork, container, false);
        }
        ...
        new NewyorkFragment.FetchWeatherForecastTask().execute();
    ...
    private List<ModelForecast> fetchFromParser1() {
        try {
            ...
            String xmlData = fetchDataFromUrl("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/5128581");
