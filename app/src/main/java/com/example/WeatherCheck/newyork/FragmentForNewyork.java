...
public class FragmentForNewyork extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String newyork = "https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/5128581";
        ...
        new AsyncTask<Void, Void, List<WeatherForecast>>() {
            ...
            protected List<WeatherForecast> doInBackground(Void... voids) {
                try {
                    ...
                    InputStream inputStream = new URL(newyork).openStream();
