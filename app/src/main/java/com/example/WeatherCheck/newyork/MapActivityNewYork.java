...
import com.google.android.material.bottomnavigation.BottomNavigationView;
    ...
    public class MapActivityNewYork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.previous) {
                    startActivity(new Intent( MapActivityNewYork.this, MainActivity.class));
                    return true;
    ...
    private void showWeatherOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityNewYork.this, MauritiusSwitch.class));
                    break;
                case 1:
                    startActivity(new Intent(MapActivityNewYork.this, LondonSwitch.class));

                    break;
                case 2:
                    startActivity(new Intent(MapActivityNewYork.this, GlasgowSwitch.class));
                    break;
                case 3:
                    startActivity(new Intent(MapActivityNewYork.this, NewyorkSwitch.class));

                    break;
                case 4:
                    startActivity(new Intent(MapActivityNewYork.this, BangladeshSwitch.class));

                    break;

                case 5:
                    startActivity(new Intent(MapActivityNewYork.this, OmanSwitch.class));
                    break;
            }
        });
    ...
    private void showMapsOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityNewYork.this, MapActivity.class));
                    break;
                case 1:

                    startActivity(new Intent(MapActivityNewYork.this, MapActivityLondon.class));
                    break;
                case 2:
                    startActivity(new Intent(MapActivityNewYork.this,MapActivityGlasgow.class));;
                    break;
                case 3:
                    startActivity(new Intent(MapActivityNewYork.this, MapActivityNewYork.class));
                    break;
                case 4:
                    startActivity(new Intent(MapActivityNewYork.this,MapActivityGlasgow.class));
                    break;
                ...
                case 5:
                    startActivity(new Intent(MapActivityNewYork.this, MapActivityOman.class));
                    break;
            }
        });
        AlertDialog dialog = builder.create();
