...
public class FragmentForGlasgow extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String glasgowUrl = "https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/2648579";

    // WeatherSensor instance
    private com.example.WeatherCheck.mauritus.WeatherSensor weatherSensor;
        ...
        new AsyncTask<Void, Void, List<WeatherForecast>>() {
            ...
            protected List<WeatherForecast> doInBackground(Void... voids) {
                try {
                    ...
                    InputStream inputStream = new URL(glasgowUrl).openStream();
