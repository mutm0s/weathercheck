package com.example.WeatherCheck.glasgow;
...
public class MapActivityGlasgow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.previous) {
                    startActivity(new Intent( MapActivityGlasgow.this, MainActivity.class));
                    return true;
    ...
    private void showWeatherOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityGlasgow.this, MauritiusSwitch.class));
                    break;
                case 1:
                    startActivity(new Intent(MapActivityGlasgow.this, LondonSwitch.class));

                    break;
                case 2:
                    startActivity(new Intent(MapActivityGlasgow.this, GlasgowSwitch.class));
                    break;
                case 3:
                    startActivity(new Intent(MapActivityGlasgow.this, NewyorkSwitch.class));

                    break;
                case 4:
                    startActivity(new Intent(MapActivityGlasgow.this, BangladeshSwitch.class));

                    break;

                case 5:
                    startActivity(new Intent(MapActivityGlasgow.this, OmanSwitch.class));
                    break;
            }
        });
    ...
    private void showMapsOptionsDialog(int arrayResourceId) {
        ...
        builder.setItems(arrayResourceId, (dialog, which) -> {
            ...
            switch (which) {
                case 0:
                    startActivity(new Intent(MapActivityGlasgow.this, MapActivity.class));
                    break;
                case 1:

                    startActivity(new Intent(MapActivityGlasgow.this, MapActivityLondon.class));
                    break;
                case 2:
                    startActivity(new Intent(MapActivityGlasgow.this,MapActivityGlasgow.class));;
                    break;
                case 3:
                    startActivity(new Intent(MapActivityGlasgow.this, MapActivityNewYork.class));
                    break;
                case 4:
                    startActivity(new Intent(MapActivityGlasgow.this,MapActivityGlasgow.class));
                    break;
                ...
                case 5:
                    startActivity(new Intent(MapActivityGlasgow.this, MapActivityOman.class));
                    break;
            }
        });
        AlertDialog dialog = builder.create();
