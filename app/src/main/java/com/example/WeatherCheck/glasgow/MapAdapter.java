...
public class MapAdapter extends RecyclerView.Adapter<MapAdapter.MapViewHolder> {
    ...
    static class MapViewHolder extends RecyclerView.ViewHolder {
        ...
        void initializeMapView() {
            ...
            mapController.setCenter(new GeoPoint(55.8642, -4.2518));

            // Add a red marker on the city with the city name
            ArrayList<OverlayItem> items = new ArrayList<>();
            GeoPoint cityLocation = new GeoPoint(55.8642, -4.2518); // City location
            OverlayItem cityOverlayItem = new OverlayItem("City", "Glasgow", cityLocation);
