...
public class GlasgowSwitch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        observerFragment = new SecFragmentForGlasgow();
        forecastFragment = new FragmentForGlasgow();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
                                                                     ...
                                                                     public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                                                                         ...
                                                                         if (id == R.id.menu_observer) {
                                                                             ...
                                                                             startActivity(new Intent(GlasgowSwitch.this, MainActivity.class));
                                                                             return true;
                                                                         }
                                                                         else {
                                                                             return false;
